...
const TranslateButton = () => {
    ...
    return (
        <div ref={translateButtonRef} className={`fixed opacity-50 rounded-md bottom-10 ${language == 'ar' ? 'left-10' : 'right-10'} flex flex-col p-2 bg-black items-center cursor-pointer`} onClick={translate} onMouseEnter={In} onMouseLeave={Out} >
