...
const AboutIntro = () => {
    ...
    return (
        <div className={`flex flex-row  gap-8`}>
            <div className={`flex flex-row h-fit gap-x-4 flex-1 about-header text-4xl font-bold uppercase`}>
                <p>{translations[language].about.title}</p>
                <div className="grow text-[#FFFAF3] border-b-black border-b">....</div>
            </div>


            <p className={`flex-1 about-text text-justify text-lg font-light uppercase`}>{translations[language].about.description}</p>
